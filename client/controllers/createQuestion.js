...
myApp.controller('makeQuestionCtrl', ['$scope', 'QuestionManager', 'userService', 'Upload', 'APIBASEURL','$uibModalInstance', function ($scope, QuestionManager, userService, Upload, APIBASEURL,$uibModalInstance) {
